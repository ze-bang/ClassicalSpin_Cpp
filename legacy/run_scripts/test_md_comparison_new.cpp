#include "../src/dynamics/unitcell.h"
#include "../src/dynamics/lattice.h"
#include <iostream>
#include <fstream>
#include <iomanip>
#include <filesystem>
...
void test_new_md(const string& initial_spins_file, double J=0, double K=-1, double Gamma=0.25, double Gammap=-0.02, double h=0.7) {
    std::cout << "========================================" << std::endl;
    std::cout << "Running NEW MD Implementation" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    MC.molecular_dynamics(0, 50, 1e-2, "MD_test_output/new", 1, "rk4");
    
    std::cout << "New MD complete. Output saved to MD_test_output/new/" << std::endl;
    std::cout << "========================================" << std::endl;
}
...
int main(int argc, char** argv) {
    ...
    test_new_md(initial_spins, J, K, Gamma, Gammap, h);
