...
int main(int argc, char** argv) {
    ...
    std::cout << "Initializing parallel tempering calculation with parameters: " << "T = " << 5 << "-" << 1e-4 << " Jpm: " << Jpm << " Jpmpm: " << Jpmpm << " H: " << h << " field direction : " << dir_string << " saving to: " << dir_name << endl;
