...
void MD_kitaev_honeycomb(int num_trials, float K, float h, string dir){
    ...
    for(int i=0; i<num_trials;++i){
        ...
        array<float, 3> field = {-h/float(sqrt(2)),h/float(sqrt(2)),0};
        ...
        MC.molecular_dynamics_SU2(10,0.001,1000000,1000000, 1000, 2000, dir+"/"+std::to_string(i));
    }
}

int main() {
    MD_kitaev_honeycomb(25, 1, 0.06, "MD_kitaev_honeycomb_T_0.001K");
}