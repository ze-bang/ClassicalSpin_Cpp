...
\texttt{ClassicalSpin\_Cpp} now ticks all eighteen, including
...
Section~\ref{sec:hoist-time}, and---new in this pass---the
sublattice-coloured intra-sweep OpenMP parallelism of
Section~\ref{sec:sublattice-colour}.  The remaining gap before
